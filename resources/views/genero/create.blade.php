    ...
    <x-nav_bar_admin>
        <div class="admin_tables">
            <div class="header_crear">
                ...
                <h1>Creando un nuevo genero</h1>
            </div>


            <form action="{{ route('genero_store') }}" method="POST">
                @csrf
                <div class="mb-6">
                    <label for="name" class="block mb-2 text-sm font-medium text-black dark:text-black">Nombre del Genero</label>
